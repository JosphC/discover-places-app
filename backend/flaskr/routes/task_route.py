...
class Tasks(MethodView):
    ...
    def get(self):
        """Protected route (JWT Required) - Get all tasks for current user"""
    ...
    @bp.response(201)
    def post(self, data):
        """Protected route (JWT Required) - Create a new task"""
...
class TaskById(MethodView):
    ...
    def get(self, task_id):
        """Protected route (JWT Required) - Get a single task by ID"""
    ...
    def put(self, data, task_id):
        """Protected route (JWT Required) - Update a task"""
        return TaskController.update(data, task_id)

    @jwt_required()
    @bp.response(204)
    def delete(self, task_id):
        """Protected route (JWT Required) - Delete a task"""
